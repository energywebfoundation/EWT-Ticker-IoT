...
As for everything else in the project, the contributions to [energywebfoundation/data-exchange-ui] are governed by our Code of Conduct[CODE_OF_CONDUCT.md].
...
The issue tracker is the preferred channel for bug reports, features requests and submitting pull requests, but please respect the following restrictions:
 ...
 - Please do not use the issue tracker for personal support requests. Use our Slack channel.
...
You need to sign a Contributor's License Agreement (CLA) as well in order to confirm that you have the rights on your own contributions.
